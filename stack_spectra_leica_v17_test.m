...
fileName_equation = 'EQst_CieLAB_17-BSK-035_linearised.m';
...
mineralSel = 1; %selecting target mineral
mineralText = annotationNames(mineralSel);
Imax_vector = [120; 120]; %max intensity found in [3D universal stage or 2D section]
