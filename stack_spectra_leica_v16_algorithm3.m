...
destDir_suffix = 'review4';%trial saving directory
plotSetup = struct;
...
%Define POAM maps
obias_folderName = 'obiasExport_linear';
...
%% Section 6: Importing blended image and grain objects 
...
[pixel_maxPeakI_discrete] = largestPeak_channels(...
    img_temp2, pol_angle1, pixel_maxPeak); %closest discrete value
