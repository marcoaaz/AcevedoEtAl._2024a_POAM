...
destDir_suffix = 'test_4Jan2024';%trial saving directory
plotSetup = struct;
...
mineralSel = 1; %selected target mineral
Imax_vector = [120, 120]; %max found in [3D universal stage or 2D section]
